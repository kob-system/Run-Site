...
| troymegawash.com | Al Barra — laundromat (JP built this) | Base44; brochure | Phase 1 |
| troyfivestar.com | Al Barra — deli | **Wix, built badly → REBUILD.** Simple: store info + "Order on DoorDash" button. **No menu/cart/e-commerce** (ordering is on DoorDash). | Phase 1 (easy rebuild) |
